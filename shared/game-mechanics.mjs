...
export function buildSeasonPassState({
  ...
  const currentEra = ZOO_ERAS[Math.min(rawEraIndex, ZOO_ERAS.length - 1)] || ZOO_ERAS[ZOO_ERAS.length - 1] || { order: rawEraIndex + 1, label: "Zoo Era", description: "" };
  ...
  return {
    ...
    levelsPerEra: PASS_LEVELS_PER_ERA,
    tiers
  };
}
