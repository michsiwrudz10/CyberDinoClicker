...
export const DINO_DEFS = RAW_DINO_DEFS.map((dino, index) => decorateDino({
  ...dino,
  unlockEra: index < 12 ? 1 : 2
}));
...
export const ZOO_ERAS = [
  {
    ...
    id: "small_zoo",
    label: "Small Zoo",
    description: "A compact beginner island with your first public dinosaur attractions."
  },
  {
    order: 2,
    id: "growing_zoo",
    label: "Medium Zoo",
    description: "A bigger island where elite predators and heavy producers start to appear."
  },
  {
    order: 3,
    id: "grand_zoo",
    label: "Large Zoo",
    description: "A prestige sanctuary with fern-bred legends and rare showcase beasts."
  }
];
